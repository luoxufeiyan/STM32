...
#ifndef __STM32F10x_H//条件编译 减少代码量 
...
#if !defined (STM32F10X_LD) && !defined (STM32F10X_LD_VL) && !defined (STM32F10X_MD) && !defined (STM32F10X_MD_VL) && !defined (STM32F10X_HD) && !defined (STM32F10X_HD_VL) && !defined (STM32F10X_XL) && !defined (STM32F10X_CL) // 修改宏文件
 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
 ...
 #ifdef STM32F10X_CL   
  #define HSE_VALUE    ((uint32_t)25000000) /*!< Value of the External oscillator in Hz */ //定义晶振
 #else 
 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup 
   Timeout value 
   */
#define HSE_STARTUP_TIMEOUT   ((uint16_t)0x0500) /*!< Time out for HSE start up */ // HSE==High Speed External 高速外部晶振 //调节内部时钟引导的外部时钟
...
/*!< STM32F10x Standard Peripheral Library old types (maintained for legacy purpose) 兼容之前版本 */
typedef int32_t  s32;
typedef int16_t s16;
typedef int8_t  s8;
